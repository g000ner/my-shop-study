 ...
 * инициализация сессионной переменной $_SESSION
 * 
 * @return json масссив данных нового пользователя
 */
...
function indexAction($smarty) {
    // если поользователь не авторизовался, то редирект на главную страницу
    if (! isset($_SESSION['user']))
        redirect ('/');
 ...
 * 
 * @return json рузультаты выполнения функции
 */
function updateAction() {
    ...
    if($res) {
        ...
        $_SESSION['user']['displayName'] = $name ? $name : $_SESSION['user']['name'];
    }else {
        $resData['success'] = 0;
